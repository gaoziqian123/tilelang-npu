...
__local half A_sh[2048];
  ...
  for (int ko = 0; ko < 40; ++ko) {
    for (int copy8_i = 0; copy8_i < 4; ++copy8_i) {
      vstore8(vload8(0, A + (((((tl_gid1 * 81920) + (copy8_i * 20480)) + ((tl_lid0 >> 3) * 2560)) + (ko * 64)) + ((tl_lid0 & 7) * 8))), 0, A_sh + ((copy8_i * 512) + tl_wi_aff4));
    }
    for (int copy8_i_1 = 0; copy8_i_1 < 16; ++copy8_i_1) {
      vstore8(vload8(0, B + (((((ko * 163840) + (copy8_i_1 * 10240)) + ((tl_lid0 >> 4) * 2560)) + (tl_gid0 * 128)) + tl_wi_aff3)), 0, B_sh + ((copy8_i_1 * 512) + tl_wi_aff4));
    }
    float8 acc_1_0;
    float8 acc_1_1;
    float8 acc_1_2;
    ...
    for (int pos4 = 0; pos4 < 16; ++pos4) { const int tl_loop_aff0 = (tl_wi_aff2 + (pos4 * 4)); const int tl_loop_aff1 = (pos4 * 512);
      float4 av_1[8];
      float8 bv_1[4];
      av_1[0] = (convert_float4(vload4(0, A_sh + tl_loop_aff0)));
      av_1[1] = (convert_float4(vload4(0, A_sh + (tl_loop_aff0 + 64))));
      av_1[2] = (convert_float4(vload4(0, A_sh + (tl_loop_aff0 + 128))));
      av_1[3] = (convert_float4(vload4(0, A_sh + (tl_loop_aff0 + 192))));
      av_1[4] = (convert_float4(vload4(0, A_sh + (tl_loop_aff0 + 256))));
      av_1[5] = (convert_float4(vload4(0, A_sh + (tl_loop_aff0 + 320))));
      av_1[6] = (convert_float4(vload4(0, A_sh + (tl_loop_aff0 + 384))));
      av_1[7] = (convert_float4(vload4(0, A_sh + (tl_loop_aff0 + 448))));
      bv_1[0] = (convert_float8(vload8(0, B_sh + (tl_loop_aff1 + tl_wi_aff3))));
      bv_1[1] = (convert_float8(vload8(0, B_sh + ((tl_loop_aff1 + tl_wi_aff3) + 128))));
      bv_1[2] = (convert_float8(vload8(0, B_sh + ((tl_loop_aff1 + tl_wi_aff3) + 256))));
      bv_1[3] = (convert_float8(vload8(0, B_sh + ((tl_loop_aff1 + tl_wi_aff3) + 384))));
  ...
  vstore8((*(half8*)(C_local_cast + 0)), 0, C + tl_wi_aff1);
  ...
  vstore8((*(half8*)(C_local_cast_1 + 0)), 0, tl_C_base + ( + 2560));
  ...
  vstore8((*(half8*)(C_local_cast_2 + 0)), 0, tl_C_base + ( + 5120));
  ...
  vstore8((*(half8*)(C_local_cast_3 + 0)), 0, tl_C_base + ( + 7680));
  ...
  vstore8((*(half8*)(C_local_cast_4 + 0)), 0, tl_C_base + ( + 10240));
  ...
  vstore8((*(half8*)(C_local_cast_5 + 0)), 0, tl_C_base + ( + 12800));
  ...
  vstore8((*(half8*)(C_local_cast_6 + 0)), 0, tl_C_base + ( + 15360));
  ...
  vstore8((*(half8*)(C_local_cast_7 + 0)), 0, tl_C_base + ( + 17920));
}
