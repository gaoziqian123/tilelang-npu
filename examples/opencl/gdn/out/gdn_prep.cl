...
__local half UW[4096];
  ...
  if (tl_lid0 < 32) {
    ...
    EgcBuf[((tl_wi_aff5 + tl_wi_aff7) + tl_lid0)] = exp(s_1[0]);
  }
  barrier(CLK_LOCAL_MEM_FENCE);
  EglBuf[((tl_gid1 * 32) + tl_gid0)] = exp(gc[31]);
  float kk_1[1];
  float qk_1[1];
  kk_1[0] = 0.000000e+00f;
  qk_1[0] = 0.000000e+00f;
  for (int kd = 0; kd < 128; ++kd) {
    float kj = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd)]));
    kk_1[0] = (kk_1[0] + ((convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd)])) * kj));
    qk_1[0] = (qk_1[0] + ((convert_float(Q[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd)])) * kj));
  }
  ...
  A2buf[((tl_wi_aff3 + tl_wi_aff6) + tl_lid0)] = (convert_half(condval_1));
  float kk_2[1];
  float qk_2[1];
  kk_2[0] = 0.000000e+00f;
  qk_2[0] = 0.000000e+00f;
  for (int kd_1 = 0; kd_1 < 128; ++kd_1) {
    float kj_1 = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd_1)]));
    kk_2[0] = (kk_2[0] + ((convert_float(K[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_1) + 512)])) * kj_1));
    qk_2[0] = (qk_2[0] + ((convert_float(Q[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_1) + 512)])) * kj_1));
  }
  ...
  A2buf[(((tl_wi_aff3 + tl_wi_aff6) + tl_lid0) + 128)] = (convert_half(condval_3));
  float kk_3[1];
  float qk_3[1];
  kk_3[0] = 0.000000e+00f;
  qk_3[0] = 0.000000e+00f;
  for (int kd_2 = 0; kd_2 < 128; ++kd_2) {
    float kj_2 = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd_2)]));
    kk_3[0] = (kk_3[0] + ((convert_float(K[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_2) + 1024)])) * kj_2));
    qk_3[0] = (qk_3[0] + ((convert_float(Q[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_2) + 1024)])) * kj_2));
  }
  ...
  A2buf[(((tl_wi_aff3 + tl_wi_aff6) + tl_lid0) + 256)] = (convert_half(condval_5));
  float kk_4[1];
  float qk_4[1];
  kk_4[0] = 0.000000e+00f;
  qk_4[0] = 0.000000e+00f;
  for (int kd_3 = 0; kd_3 < 128; ++kd_3) {
    float kj_3 = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd_3)]));
    kk_4[0] = (kk_4[0] + ((convert_float(K[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_3) + 1536)])) * kj_3));
    qk_4[0] = (qk_4[0] + ((convert_float(Q[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_3) + 1536)])) * kj_3));
  }
  ...
  A2buf[(((tl_wi_aff3 + tl_wi_aff6) + tl_lid0) + 384)] = (convert_half(condval_7));
  float kk_5[1];
  float qk_5[1];
  kk_5[0] = 0.000000e+00f;
  qk_5[0] = 0.000000e+00f;
  for (int kd_4 = 0; kd_4 < 128; ++kd_4) {
    float kj_4 = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd_4)]));
    kk_5[0] = (kk_5[0] + ((convert_float(K[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_4) + 2048)])) * kj_4));
    qk_5[0] = (qk_5[0] + ((convert_float(Q[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_4) + 2048)])) * kj_4));
  }
  ...
  A2buf[(((tl_wi_aff3 + tl_wi_aff6) + tl_lid0) + 512)] = (convert_half(condval_9));
  float kk_6[1];
  float qk_6[1];
  kk_6[0] = 0.000000e+00f;
  qk_6[0] = 0.000000e+00f;
  for (int kd_5 = 0; kd_5 < 128; ++kd_5) {
    float kj_5 = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd_5)]));
    kk_6[0] = (kk_6[0] + ((convert_float(K[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_5) + 2560)])) * kj_5));
    qk_6[0] = (qk_6[0] + ((convert_float(Q[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_5) + 2560)])) * kj_5));
  }
  ...
  A2buf[(((tl_wi_aff3 + tl_wi_aff6) + tl_lid0) + 640)] = (convert_half(condval_11));
  float kk_7[1];
  float qk_7[1];
  kk_7[0] = 0.000000e+00f;
  qk_7[0] = 0.000000e+00f;
  for (int kd_6 = 0; kd_6 < 128; ++kd_6) {
    float kj_6 = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd_6)]));
    kk_7[0] = (kk_7[0] + ((convert_float(K[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_6) + 3072)])) * kj_6));
    qk_7[0] = (qk_7[0] + ((convert_float(Q[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_6) + 3072)])) * kj_6));
  }
  ...
  A2buf[(((tl_wi_aff3 + tl_wi_aff6) + tl_lid0) + 768)] = (convert_half(condval_13));
  float kk_8[1];
  float qk_8[1];
  kk_8[0] = 0.000000e+00f;
  qk_8[0] = 0.000000e+00f;
  for (int kd_7 = 0; kd_7 < 128; ++kd_7) {
    float kj_7 = (convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff1) + kd_7)]));
    kk_8[0] = (kk_8[0] + ((convert_float(K[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_7) + 3584)])) * kj_7));
    qk_8[0] = (qk_8[0] + ((convert_float(Q[((((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_wi_aff0) + kd_7) + 3584)])) * kj_7));
  }
  ...
  A2buf[(((tl_wi_aff3 + tl_wi_aff6) + tl_lid0) + 896)] = (convert_half(condval_15));
  barrier(CLK_LOCAL_MEM_FENCE);
  for (int i = 0; i < 32; ++i) {
    float au_1[1];
  ...
  for (int i_3 = 0; i_3 < 32; ++i_3) { const int tl_loop_aff0 = (i_3 * 128);
    ...
    KDbuf[(((tl_wi_aff2 + tl_wi_aff4) + tl_loop_aff0) + tl_lid0)] = (convert_half(((convert_float(K[(((((tl_gid1 & 15) * 131072) + tl_wi_aff4) + tl_loop_aff0) + tl_lid0)])) * exp((gc[31] - gc[i_3])))));
  }
}
