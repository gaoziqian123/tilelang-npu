...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A, __global half* restrict B, __global half* restrict C) { const int tl_gid0 = convert_int(get_group_id(0)); const int tl_gid1 = convert_int(get_group_id(1)); const int tl_lid0 = convert_int(get_local_id(0)); const int tl_wi_aff0 = ((tl_gid1 * 147456) + ((tl_lid0 >> 4) * 73728)); const int tl_wi_aff1 = ((tl_gid1 * 40960) + ((tl_lid0 >> 4) * 20480)); const int tl_wi_aff2 = ((tl_wi_aff1 + (tl_gid0 * 128)) + ((tl_lid0 & 15) * 8)); const int tl_wi_aff3 = ((tl_lid0 >> 4) * 128); const int tl_wi_aff4 = (tl_gid0 * 128); const int tl_wi_aff5 = (tl_lid0 * 8);
  ...
  for (int pos4 = 0; pos4 < 2304; ++pos4) { const int tl_loop_aff0 = (tl_wi_aff0 + (pos4 * 4)); const int tl_loop_aff1 = (((pos4 * 10240) + tl_wi_aff4) + tl_wi_aff5);
    float4 av_1[8];
    float8 bv_1[4];
