...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A, __global half* restrict B, __global half* restrict C) {
  ...
  for (int pos4 = 0; pos4 < 640; ++pos4) {
    ...
    bv_1[0] = (convert_float8(vload8(0, B + ((((pos4 * 36864) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
    bv_1[1] = (convert_float8(vload8(0, B + (((((pos4 * 36864) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 9216) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
    bv_1[2] = (convert_float8(vload8(0, B + (((((pos4 * 36864) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 18432) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
    bv_1[3] = (convert_float8(vload8(0, B + (((((pos4 * 36864) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 27648) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
