...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A, __global half* restrict B, __global half* restrict C) {
  __local uchar buf_dyn_shmem[10240];
  void* B_sh = ((void*)((char*)buf_dyn_shmem + 0));
  void* A_sh = ((void*)((char*)buf_dyn_shmem + 8192));
  float C_frag[64];
  half acc16[64];
  float C_frag_1[64];
  ...
  for (int c = 0; c < 80; ++c) {
    half acc16_1[64];
    for (int copy8_i = 0; copy8_i < 2; ++copy8_i) {
      vstore8(vload8(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (copy8_i * 40960)) + (((convert_int(get_local_id(0))) >> 2) * 2560)) + (c * 32)) + (((convert_int(get_local_id(0))) & 3) * 8))), 0, (half*)A_sh + ((copy8_i * 512) + ((convert_int(get_local_id(0))) * 8)));
    }
    for (int copy8_i_1 = 0; copy8_i_1 < 8; ++copy8_i_1) {
      vstore8(vload8(0, B + (((((c * 294912) + (copy8_i_1 * 36864)) + (((convert_int(get_local_id(0))) >> 4) * 9216)) + ((convert_int(get_group_id(0))) * 128)) + (((convert_int(get_local_id(0))) & 15) * 8))), 0, (half*)B_sh + ((copy8_i_1 * 512) + ((convert_int(get_local_id(0))) * 8)));
    }
    half8 acc[8];
    half4 av[8];
    half8 bv[4];
    ...
    for (int pos4 = 0; pos4 < 8; ++pos4) {
      half4 av_1[8];
      half8 bv_1[4];
      av_1[0] = vload4(0, (half*)A_sh + ((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)));
      av_1[1] = vload4(0, (half*)A_sh + (((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)) + 32));
      av_1[2] = vload4(0, (half*)A_sh + (((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)) + 64));
      av_1[3] = vload4(0, (half*)A_sh + (((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)) + 96));
      av_1[4] = vload4(0, (half*)A_sh + (((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)) + 128));
      av_1[5] = vload4(0, (half*)A_sh + (((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)) + 160));
      av_1[6] = vload4(0, (half*)A_sh + (((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)) + 192));
      av_1[7] = vload4(0, (half*)A_sh + (((((convert_int(get_local_id(0))) >> 4) * 256) + (pos4 * 4)) + 224));
