...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A, __global half* restrict B, __global half* restrict C) {
  ...
  for (int c = 0; c < 10; ++c) {
    ...
    for (int pos4 = 0; pos4 < 640; ++pos4) {
      half4 av_1[8];
      half8 bv_1[4];
      av_1[0] = vload4(0, A + (((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)));
      av_1[1] = vload4(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)) + 2560));
      av_1[2] = vload4(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)) + 5120));
      av_1[3] = vload4(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)) + 7680));
      av_1[4] = vload4(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)) + 10240));
      av_1[5] = vload4(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)) + 12800));
      av_1[6] = vload4(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)) + 15360));
      av_1[7] = vload4(0, A + ((((((convert_int(get_group_id(1))) * 81920) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + (c * 256)) + (pos4 * 4)) + 17920));
      bv_1[0] = vload8(0, B + (((((c * 2359296) + (pos4 * 36864)) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) - (((convert_int(get_local_id(0))) >> 4) * 128)));
      bv_1[1] = vload8(0, B + ((((((c * 2359296) + (pos4 * 36864)) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 9216) - (((convert_int(get_local_id(0))) >> 4) * 128)));
      bv_1[2] = vload8(0, B + ((((((c * 2359296) + (pos4 * 36864)) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 18432) - (((convert_int(get_local_id(0))) >> 4) * 128)));
      bv_1[3] = vload8(0, B + ((((((c * 2359296) + (pos4 * 36864)) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 27648) - (((convert_int(get_local_id(0))) >> 4) * 128)));
