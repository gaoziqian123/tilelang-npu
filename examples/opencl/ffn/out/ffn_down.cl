...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A, __global half* restrict B, __global half* restrict C) {
  ...
  for (int pos4 = 0; pos4 < 2304; ++pos4) {
    float4 av_1[8];
    float8 bv_1[4];
    av_1[0] = (convert_float4(vload4(0, A + ((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)))));
    av_1[1] = (convert_float4(vload4(0, A + (((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)) + 9216))));
    av_1[2] = (convert_float4(vload4(0, A + (((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)) + 18432))));
    av_1[3] = (convert_float4(vload4(0, A + (((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)) + 27648))));
    av_1[4] = (convert_float4(vload4(0, A + (((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)) + 36864))));
    av_1[5] = (convert_float4(vload4(0, A + (((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)) + 46080))));
    av_1[6] = (convert_float4(vload4(0, A + (((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)) + 55296))));
    av_1[7] = (convert_float4(vload4(0, A + (((((convert_int(get_group_id(1))) * 294912) + (((convert_int(get_local_id(0))) >> 4) * 73728)) + (pos4 * 4)) + 64512))));
    bv_1[0] = (convert_float8(vload8(0, B + ((((pos4 * 10240) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
    bv_1[1] = (convert_float8(vload8(0, B + (((((pos4 * 10240) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 2560) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
    bv_1[2] = (convert_float8(vload8(0, B + (((((pos4 * 10240) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 5120) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
    bv_1[3] = (convert_float8(vload8(0, B + (((((pos4 * 10240) + ((convert_int(get_group_id(0))) * 128)) + ((convert_int(get_local_id(0))) * 8)) + 7680) - (((convert_int(get_local_id(0))) >> 4) * 128)))));
