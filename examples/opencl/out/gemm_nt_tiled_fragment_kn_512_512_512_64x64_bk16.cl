...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int kb = 0; kb < 512; kb += 16) {
    for (int v = (convert_int(get_local_id(0))); v < 256; v += 64) {
      int r = (v >> 2);
      int c4 = (v - ((v >> 2) * 4));
      half4 aval = vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + ((v >> 2) * 496)) + (v * 4)) + kb)));
    ...
    for (int v_1 = (convert_int(get_local_id(0))); v_1 < 128; v_1 += 64) {
      int k = (v_1 >> 3);
      int c8 = (v_1 - ((v_1 >> 3) * 8));
      half8 bval = vload8(0, ((__global half *)B_1 + ((((kb * 512) + ((v_1 >> 3) * 448)) + ((convert_int(get_group_id(0))) * 64)) + (v_1 * 8))));
