...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int kbb = 0; kbb < 32; ++kbb) {
    for (int v = (convert_int(get_local_id(0))); v < 256; v += 64) {
      int r = (v >> 2);
      int c4 = (v - ((v >> 2) * 4));
      half4 aval = vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + ((v >> 2) * 496)) + (kbb * 16)) + (v * 4)));
    ...
    for (int v_1 = (convert_int(get_local_id(0))); v_1 < 128; v_1 += 64) {
      int k = (v_1 >> 3);
      int c8 = (v_1 - ((v_1 >> 3) * 8));
      vstore8(vload8(0, B_1 + ((((kbb * 8192) + ((v_1 >> 3) * 448)) + ((convert_int(get_group_id(0))) * 64)) + (v_1 * 8))), 0, Bs + (v_1 * 8));
    }
