...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int pos4 = 0; pos4 < 128; ++pos4) {
    float4 a0 = (convert_float4(vload4(0, A_1 + ((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)))));
    float4 a1 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 512))));
    float4 a2 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 1024))));
    float4 a3 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 1536))));
    float4 a4 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 2048))));
    float4 a5 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 2560))));
    float4 a6 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 3072))));
    float4 a7 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 3584))));
    float4 b0 = (convert_float4(vload4(0, B_1 + (((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
    float4 b1 = (convert_float4(vload4(0, B_1 + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 512) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
    float4 b2 = (convert_float4(vload4(0, B_1 + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 1024) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
    float4 b3 = (convert_float4(vload4(0, B_1 + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 1536) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
    float4 b4 = (convert_float4(vload4(0, B_1 + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 2048) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
    float4 b5 = (convert_float4(vload4(0, B_1 + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 2560) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
    float4 b6 = (convert_float4(vload4(0, B_1 + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 3072) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
    float4 b7 = (convert_float4(vload4(0, B_1 + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 3584) - (((convert_int(get_local_id(0))) >> 4) * 65536)))));
