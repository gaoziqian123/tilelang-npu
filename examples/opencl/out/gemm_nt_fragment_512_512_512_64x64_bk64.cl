...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int pos = 0; pos < 512; pos += 4) {
    float4 a0 = convert_float4(vload4(0, ((__global half *)A_1 + ((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos))));
    float4 a1 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos) + 512))));
    float4 a2 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos) + 1024))));
    float4 a3 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos) + 1536))));
    float4 a4 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos) + 2048))));
    float4 a5 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos) + 2560))));
    float4 a6 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos) + 3072))));
    float4 a7 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4096)) + pos) + 3584))));
    float4 b0 = convert_float4(vload4(0, ((__global half *)B_1 + (((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
    float4 b1 = convert_float4(vload4(0, ((__global half *)B_1 + ((((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) + 512) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
    float4 b2 = convert_float4(vload4(0, ((__global half *)B_1 + ((((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) + 1024) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
    float4 b3 = convert_float4(vload4(0, ((__global half *)B_1 + ((((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) + 1536) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
    float4 b4 = convert_float4(vload4(0, ((__global half *)B_1 + ((((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) + 2048) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
    float4 b5 = convert_float4(vload4(0, ((__global half *)B_1 + ((((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) + 2560) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
    float4 b6 = convert_float4(vload4(0, ((__global half *)B_1 + ((((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) + 3072) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
    float4 b7 = convert_float4(vload4(0, ((__global half *)B_1 + ((((((convert_int(get_group_id(0))) * 32768) + ((convert_int(get_local_id(0))) * 4096)) + pos) + 3584) - (((convert_int(get_local_id(0))) >> 3) * 32768)))));
  ...
  vstore8((convert_half8(acc_0)), 0, C_1 + (((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)));
  vstore8((convert_half8(acc_1)), 0, C_1 + ((((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)) + 512));
  vstore8((convert_half8(acc_2)), 0, C_1 + ((((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)) + 1024));
  vstore8((convert_half8(acc_3)), 0, C_1 + ((((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)) + 1536));
  vstore8((convert_half8(acc_4)), 0, C_1 + ((((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)) + 2048));
  vstore8((convert_half8(acc_5)), 0, C_1 + ((((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)) + 2560));
  vstore8((convert_half8(acc_6)), 0, C_1 + ((((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)) + 3072));
  vstore8((convert_half8(acc_7)), 0, C_1 + ((((((convert_int(get_group_id(1))) * 32768) + (((convert_int(get_local_id(0))) >> 3) * 4032)) + ((convert_int(get_group_id(0))) * 64)) + ((convert_int(get_local_id(0))) * 8)) + 3584));
}
