...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int pos4 = 0; pos4 < 128; ++pos4) {
    float4 a0 = (convert_float4(vload4(0, A_1 + ((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)))));
    float4 a1 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 512))));
    float4 a2 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 1024))));
    float4 a3 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 1536))));
    float4 a4 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 2048))));
    float4 a5 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 2560))));
    float4 a6 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 3072))));
    float4 a7 = (convert_float4(vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (pos4 * 4)) + 3584))));
