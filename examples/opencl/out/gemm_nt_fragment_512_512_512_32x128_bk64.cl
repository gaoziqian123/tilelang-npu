...
__kernel void gemm_nt_kernel_kernel(__global half *restrict A,
  ...
  const int tm = lid / 16;
  const int tn = lid - tm * 16;
  const int r0 = by * 32 + tm * 8;
  ...
  for (int pos = 0; pos < 512; pos += 4) {
    const float4 a0 = convert_float4(vload4(0, A + (size_t)(r0 + 0) * 512 + pos));
    const float4 a1 = convert_float4(vload4(0, A + (size_t)(r0 + 1) * 512 + pos));
    const float4 a2 = convert_float4(vload4(0, A + (size_t)(r0 + 2) * 512 + pos));
    const float4 a3 = convert_float4(vload4(0, A + (size_t)(r0 + 3) * 512 + pos));
    const float4 a4 = convert_float4(vload4(0, A + (size_t)(r0 + 4) * 512 + pos));
    const float4 a5 = convert_float4(vload4(0, A + (size_t)(r0 + 5) * 512 + pos));
    const float4 a6 = convert_float4(vload4(0, A + (size_t)(r0 + 6) * 512 + pos));
    const float4 a7 = convert_float4(vload4(0, A + (size_t)(r0 + 7) * 512 + pos));
    const float4 b0 = convert_float4(vload4(0, B + (size_t)(c0 + 0) * 512 + pos));
    const float4 b1 = convert_float4(vload4(0, B + (size_t)(c0 + 1) * 512 + pos));
    const float4 b2 = convert_float4(vload4(0, B + (size_t)(c0 + 2) * 512 + pos));
    const float4 b3 = convert_float4(vload4(0, B + (size_t)(c0 + 3) * 512 + pos));
    const float4 b4 = convert_float4(vload4(0, B + (size_t)(c0 + 4) * 512 + pos));
    const float4 b5 = convert_float4(vload4(0, B + (size_t)(c0 + 5) * 512 + pos));
    const float4 b6 = convert_float4(vload4(0, B + (size_t)(c0 + 6) * 512 + pos));
    const float4 b7 = convert_float4(vload4(0, B + (size_t)(c0 + 7) * 512 + pos));
  ...
  vstore8(convert_half8(acc_0), 0, C + (size_t)(r0 + 0) * 512 + c0);
  vstore8(convert_half8(acc_1), 0, C + (size_t)(r0 + 1) * 512 + c0);
  vstore8(convert_half8(acc_2), 0, C + (size_t)(r0 + 2) * 512 + c0);
  vstore8(convert_half8(acc_3), 0, C + (size_t)(r0 + 3) * 512 + c0);
  vstore8(convert_half8(acc_4), 0, C + (size_t)(r0 + 4) * 512 + c0);
  vstore8(convert_half8(acc_5), 0, C + (size_t)(r0 + 5) * 512 + c0);
  vstore8(convert_half8(acc_6), 0, C + (size_t)(r0 + 6) * 512 + c0);
  vstore8(convert_half8(acc_7), 0, C + (size_t)(r0 + 7) * 512 + c0);
}
