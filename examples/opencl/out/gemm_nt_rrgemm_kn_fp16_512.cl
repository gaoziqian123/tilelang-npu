...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A, __global half* restrict B, __global half* restrict C) {
  ...
  for (int ko = 0; ko < 8; ++ko) {
    ...
    half B_frag[512];
    for (int i = 0; i < 64; ++i) {
      vstore8(vload8(0, A + ((((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + ((i >> 3) * 512)) + (ko * 64)) + ((i & 7) * 8))), 0, A_frag + (i * 8));
    }
    for (int i_1 = 0; i_1 < 64; ++i_1) {
      vstore8(vload8(0, B + ((((ko * 32768) + (i_1 * 512)) + ((convert_int(get_group_id(0))) * 128)) + (((convert_int(get_local_id(0))) & 15) * 8))), 0, B_frag + (i_1 * 8));
    }
    half8 acc[8];
    if (ko == 0) {
  ...
  for (int i_2 = 0; i_2 < 8; ++i_2) {
    vstore8(vload8(0, C_frag + (i_2 * 8)), 0, C + ((((((convert_int(get_group_id(1))) * 16384) + (((convert_int(get_local_id(0))) >> 4) * 4096)) + (i_2 * 512)) + ((convert_int(get_group_id(0))) * 128)) + (((convert_int(get_local_id(0))) & 15) * 8)));
  }
}
