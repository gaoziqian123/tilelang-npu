...
__kernel void gemm_nt_texstaged_kernel_kernel(__global half* restrict A, __read_only image2d_array_t B, __global half* restrict C) {
  ...
  for (int ko = 0; ko < 160; ++ko) {
    for (int vi = 0; vi < 2; ++vi) {
      ((half*)A_shared)[(((((convert_int(get_local_id(0))) & 3) * 256) + (vi * 32)) + ((convert_int(get_local_id(0))) >> 2))] = A[((((((convert_int(get_group_id(1))) * 163840) + (vi * 81920)) + (((convert_int(get_local_id(0))) >> 2) * 2560)) + (ko * 16)) + (((convert_int(get_local_id(0))) & 3) * 4))];
      ((half*)A_shared)[((((((convert_int(get_local_id(0))) & 3) * 256) + (vi * 32)) + ((convert_int(get_local_id(0))) >> 2)) + 64)] = A[(((((((convert_int(get_group_id(1))) * 163840) + (vi * 81920)) + (((convert_int(get_local_id(0))) >> 2) * 2560)) + (ko * 16)) + (((convert_int(get_local_id(0))) & 3) * 4)) + 1)];
      ((half*)A_shared)[((((((convert_int(get_local_id(0))) & 3) * 256) + (vi * 32)) + ((convert_int(get_local_id(0))) >> 2)) + 128)] = A[(((((((convert_int(get_group_id(1))) * 163840) + (vi * 81920)) + (((convert_int(get_local_id(0))) >> 2) * 2560)) + (ko * 16)) + (((convert_int(get_local_id(0))) & 3) * 4)) + 2)];
      ((half*)A_shared)[((((((convert_int(get_local_id(0))) & 3) * 256) + (vi * 32)) + ((convert_int(get_local_id(0))) >> 2)) + 192)] = A[(((((((convert_int(get_group_id(1))) * 163840) + (vi * 81920)) + (((convert_int(get_local_id(0))) >> 2) * 2560)) + (ko * 16)) + (((convert_int(get_local_id(0))) & 3) * 4)) + 3)];
    }
