...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int kbb = 0; kbb < 8; ++kbb) {
    for (int v = (convert_int(get_local_id(0))); v < 1024; v += 128) {
      int r = (v >> 4);
      int c4 = (v - ((v >> 4) * 16));
      half4 aval = vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 32768) + ((v >> 4) * 448)) + (kbb * 64)) + (v * 4)));
    ...
    for (int v_1 = (convert_int(get_local_id(0))); v_1 < 2048; v_1 += 128) {
      int c = (v_1 >> 4);
      int k4 = (v_1 - ((v_1 >> 4) * 16));
      half4 bval = vload4(0, B_1 + (((((convert_int(get_group_id(0))) * 65536) + ((v_1 >> 4) * 448)) + (kbb * 64)) + (v_1 * 4)));
