...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int pos = 0; pos < 2560; pos += 4) {
    float4 a0 = convert_float4(vload4(0, ((__global half *)A_1 + ((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos))));
    float4 a1 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos) + 2560))));
    float4 a2 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos) + 5120))));
    float4 a3 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos) + 7680))));
    float4 a4 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos) + 10240))));
    float4 a5 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos) + 12800))));
    float4 a6 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos) + 15360))));
    float4 a7 = convert_float4(vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 163840) + (((convert_int(get_local_id(0))) >> 4) * 20480)) + pos) + 17920))));
