...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int kbb = 0; kbb < 80; ++kbb) {
    for (int v = (convert_int(get_local_id(0))); v < 512; v += 128) {
      int r = (v >> 3);
      int c4 = (v - ((v >> 3) * 8));
      half4 aval = vload4(0, A_1 + (((((convert_int(get_group_id(1))) * 163840) + ((v >> 3) * 2528)) + (kbb * 32)) + (v * 4)));
    ...
    for (int v_1 = (convert_int(get_local_id(0))); v_1 < 1024; v_1 += 128) {
      int c = (v_1 >> 3);
      int k4 = (v_1 - ((v_1 >> 3) * 8));
      half4 bval = vload4(0, B_1 + (((((convert_int(get_group_id(0))) * 327680) + ((v_1 >> 3) * 2528)) + (kbb * 32)) + (v_1 * 4)));
