...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A, __global half* restrict B, __global half* restrict C) {
  ...
  for (int pos4 = 0; pos4 < 128; ++pos4) {
    ...
    bg_1[0] = vload4(0, B + (((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
    bg_1[1] = vload4(0, B + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 512) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
    bg_1[2] = vload4(0, B + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 1024) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
    bg_1[3] = vload4(0, B + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 1536) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
    bg_1[4] = vload4(0, B + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 2048) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
    bg_1[5] = vload4(0, B + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 2560) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
    bg_1[6] = vload4(0, B + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 3072) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
    bg_1[7] = vload4(0, B + ((((((convert_int(get_group_id(0))) * 65536) + ((convert_int(get_local_id(0))) * 4096)) + (pos4 * 4)) + 3584) - (((convert_int(get_local_id(0))) >> 4) * 65536)));
