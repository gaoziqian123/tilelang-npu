...
__kernel void gemm_nt_texstaged_kernel_kernel(__global half* restrict A, __read_only image2d_array_t B, __global half* restrict C) {
  ...
  for (int ko = 0; ko < 16; ++ko) {
    for (int vi = 0; vi < 4; ++vi) {
      ((half*)A_shared)[(((((convert_int(get_local_id(0))) & 7) * 256) + (vi * 16)) + ((convert_int(get_local_id(0))) >> 3))] = A[((((((convert_int(get_group_id(1))) * 32768) + (vi * 8192)) + (((convert_int(get_local_id(0))) >> 3) * 512)) + (ko * 32)) + (((convert_int(get_local_id(0))) & 7) * 4))];
      ((half*)A_shared)[((((((convert_int(get_local_id(0))) & 7) * 256) + (vi * 16)) + ((convert_int(get_local_id(0))) >> 3)) + 64)] = A[(((((((convert_int(get_group_id(1))) * 32768) + (vi * 8192)) + (((convert_int(get_local_id(0))) >> 3) * 512)) + (ko * 32)) + (((convert_int(get_local_id(0))) & 7) * 4)) + 1)];
      ((half*)A_shared)[((((((convert_int(get_local_id(0))) & 7) * 256) + (vi * 16)) + ((convert_int(get_local_id(0))) >> 3)) + 128)] = A[(((((((convert_int(get_group_id(1))) * 32768) + (vi * 8192)) + (((convert_int(get_local_id(0))) >> 3) * 512)) + (ko * 32)) + (((convert_int(get_local_id(0))) & 7) * 4)) + 2)];
      ((half*)A_shared)[((((((convert_int(get_local_id(0))) & 7) * 256) + (vi * 16)) + ((convert_int(get_local_id(0))) >> 3)) + 192)] = A[(((((((convert_int(get_group_id(1))) * 32768) + (vi * 8192)) + (((convert_int(get_local_id(0))) >> 3) * 512)) + (ko * 32)) + (((convert_int(get_local_id(0))) & 7) * 4)) + 3)];
    }
