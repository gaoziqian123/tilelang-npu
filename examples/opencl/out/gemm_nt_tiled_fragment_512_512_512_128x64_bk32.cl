...
__kernel void gemm_nt_kernel_kernel(__global half* restrict A_1, __global half* restrict B_1, __global half* restrict C_1) {
  ...
  for (int kb = 0; kb < 512; kb += 32) {
    for (int v = (convert_int(get_local_id(0))); v < 1024; v += 128) {
      int r = (v >> 3);
      int c4 = (v - ((v >> 3) * 8));
      half4 aval = vload4(0, ((__global half *)A_1 + (((((convert_int(get_group_id(1))) * 65536) + ((v >> 3) * 480)) + (v * 4)) + kb)));
      As[((v * 512) - ((v >> 3) * 4095))] = (aval).s0;
      As[(((v * 512) + 128) - ((v >> 3) * 4095))] = (aval).s1;
      As[(((v * 512) + 256) - ((v >> 3) * 4095))] = (aval).s2;
      As[(((v * 512) + 384) - ((v >> 3) * 4095))] = (aval).s3;
    }
